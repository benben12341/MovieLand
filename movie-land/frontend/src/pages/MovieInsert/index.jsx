...
const Movie = () => {
  ...
  const handleSubmit = () => {
    dispatch(createMovie(inputs, isAuthenticatedWithGoogle));
  };
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              label={'Director'}
              value={director}
              onChange={(event) => onChange(event, 'director')}
              variant={'outlined'}
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              label={'Writer'}
              value={writer}
              onChange={(event) => onChange(event, 'writer')}
              variant={'outlined'}
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              rows={4}
              value={summary}
              onChange={(event) => onChange(event, 'summary')}
              variant={'outlined'}
            />
          </Grid>
          <Grid item xs={12}>
            <GenresSelect
              value={genre}
              onChange={(event) => onChange(event, 'genre')}
            />
          </Grid>
          <Grid item xs={12}>
